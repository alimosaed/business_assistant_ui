...
const LoginPage = () => {
  ...
  const handleAppleLogin = () => {
    window.location.href = `${process.env.NEXT_PUBLIC_API_URL}/auth/login?provider=apple`;
  };

  const handleMicrosoftLogin = () => {
    window.location.href = `${process.env.NEXT_PUBLIC_API_URL}/auth/login?provider=microsoft`;
  };
